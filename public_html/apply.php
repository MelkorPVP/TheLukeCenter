...
<section class="hero text-center text-hero border-bottom">
    <div class="container py-5">
        ...
        <p class="fs-5 mb-0">The Pacific Program – October 12th - 16th, The Oregon Gardens</p>
    </div>
</section>
            ...
            <div class="col-lg-9">
                ...
                <form id="applyForm" class="needs-validation" action="handleApplyForm.php" method="post">
                    ...
                    <div class="d-grid d-sm-flex gap-3 mt-4">
                        <button class="btn btn-brand" type="submit" id="applyButton">Submit Application</button>
