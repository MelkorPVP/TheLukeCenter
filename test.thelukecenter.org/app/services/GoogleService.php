...
/**
     * List files in a Drive folder, optionally filtering by MIME type.
     *
     * @param array<string,mixed> $googleConfig
     * @param string              $folderId
     * @param string|null         $mimeType  e.g. 'application/pdf'
     * @return array<int, array<string,mixed>>
     */
    function google_drive_list_files_in_folder(
        array $googleConfig,
        string $folderId,
        ...
        if ($mimeType !== null && $mimeType !== '') {
            $q .= sprintf(" and mimeType = '%s'", $mimeType);
        }
