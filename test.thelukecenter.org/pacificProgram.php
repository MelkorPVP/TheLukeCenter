<?php        
    ...
    $programFlyerPdf = site_content_program_flyer_pdf($config, $logger);
    
    if (empty($programFlyerPdf)) {
        // Points to contact page or stays on page if no PDF is found
        $programFlyerPdf = 'pacificProgram.php#'; 
    }
                    ...
                    <div class="col-12 col-md-5 d-flex">                                                
                        <div class="card h-100 flex-fill border-0">                                                        
                            <div class="card-body">                                                                
                                ...
                                <div class="text-center">                                                                        
                                    <a class="btn btn-outline-brand" href="<?= htmlspecialchars($programFlyerPdf) ?>" target="_blank" rel="noopener">Program Flyer</a>                                                                        
                                </div>                                                                
                            </div>                                                        
                        </div>                                                
                    </div>                                        
